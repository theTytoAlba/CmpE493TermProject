...
public class MutualInformationHelper {
    ...
    public static ArrayList<ArrayList<String>> getFeatures(HashMap<String, Double> p_given_pos, HashMap<String, Double> p_given_not, HashMap<String, Double> p_given_neg, int LIMIT) {
        ...
        List<Map.Entry<String, Double>> sorted_map_pos = sortHashmap(p_given_pos);

        List<Map.Entry<String, Double>> sorted_map_neg = sortHashmap(p_given_neg);

        List<Map.Entry<String, Double>> sorted_map_not = sortHashmap(p_given_not);
    ...
    private static List<Map.Entry<String,Double>> sortHashmap(HashMap<String, Double> map) {
        return map.entrySet()
                .stream()
